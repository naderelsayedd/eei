...
@section('css')
    ...
    <link href="{{ url('admin/plugins/src/apex/apexcharts.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ url('admin/assets/css/light/dashboard/dash_1.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('admin/assets/css/dark/dashboard/dash_1.css') }}" rel="stylesheet" type="text/css" />
            ...
            <div class="widget-content">
                <div class="account-box">
                    ...
                    <div class="info-box">
                        <div class="icon">
                            <span>
                                <img src="{{ url('admin/assets/img/money-bag.png') }}" alt="money-bag">
                            </span>
                        </div>
                ...
                <div class="meta-info">
                    ...
                    <div class="avatar--group">
                        ...
                        <div class="avatar translateY-axis">
                            <img alt="avatar" src="{{ url('admin/assets/img/profile-8.jpeg') }}"/>
                        </div>
                        <div class="avatar translateY-axis">
                            <img alt="avatar" src="{{ url('admin/assets/img/profile-12.jpeg') }}"/>
                        </div>
                        <div class="avatar translateY-axis">
                            <img alt="avatar" src="{{ url('admin/assets/img/profile-19.jpeg') }}"/>
                        </div>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-card-one">
            <div class="widget-content">
                ...
                <div class="media">
                    <div class="w-img">
                        <img src="{{ url('admin/assets/img/profile-19.jpeg') }}" alt="avatar">
                    </div>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-card-two">
            <div class="widget-content">
                ...
                <div class="media">
                    <div class="w-img">
                        <img src="{{ url('admin/assets/img/g-8.png') }}" alt="avatar">
                    </div>
                    <div class="media-body">
                ...
                <div class="card-bottom-section">
                    ...
                    <div class="img-group">
                        <img src="{{ url('admin/assets/img/profile-19.jpeg') }}" alt="avatar">
                        <img src="{{ url('admin/assets/img/profile-6.jpeg') }}" alt="avatar">
                        <img src="{{ url('admin/assets/img/profile-8.jpeg') }}" alt="avatar">
                        <img src="{{ url('admin/assets/img/profile-3.jpeg') }}" alt="avatar">
                    </div>
...
@section('js')
    ...
    <script src="{{ url('admin/plugins/src/apex/apexcharts.min.j') }}s"></script>
