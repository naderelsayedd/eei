                            ...
                            <tbody>
                                ...
                                @foreach ($services as $service)
                                    <tr role="row">
                                        ...
                                        <td class="text-center">{{ $service->created_at->format('Y-m-d H:i a') }}</td>
                                        <td class="text-center">{{ $service->updated_at->format('Y-m-d H:i a') }}</td>
                                            ...
                                            <ul class="table-controls action-btns">
                                                ...
                                                <li>
                                                    <button type="button" title="delete"
                                                        ...
                                                        data-bs-target="#deleteFish{{ $service->id }}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    <div class="modal modal-lg fade fadeInDown"
                                                        id="deleteFish{{ $service->id }}" tabindex="-1" role="dialog"
