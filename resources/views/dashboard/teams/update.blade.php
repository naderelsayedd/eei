                            ...
                            <form action="{{ route('teams.update', ['team' => $team->id]) }}" method="post"
                                                    ...
                                                    <div class="col-12 ">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <input type="text" name="name[{{ $key }}]"
                                                                ...
                                                                value="{{ old('name', $team->getTranslations()['name'][$key]) }}"
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <input type="text" name="job_title[{{ $key }}]"
                                                                ...
                                                                value="    {{ old('job_title', $team->getTranslations()['job_title'][$key]) }}"
                                                                placeholder="Crop job_title">
                                                            @error('job_title')
                                                                <div class="invalid-feedback">
                                                                    <strong>{{ $message }}</strong>
                                                                </div>
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <textarea name="bio[{{ $key }}]" class="form-control" placeholder="Crop mini bio">
                                                                {{ old('bio', $team->getTranslations()['bio'][$key]) }}
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="facebook_url"
                                        ...
                                        value="{{ old('facebook_url', $team->facebook_url) }}" placeholder="facebook_url">
                                    @error('facebook_url')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="twitter_url"
                                        ...
                                        value="{{ old('twitter_url', $team->twitter_url) }}" placeholder="twitter_url">
                                    @error('twitter_url')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </div>
