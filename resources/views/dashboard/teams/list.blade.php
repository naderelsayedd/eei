                        ...
                        <table id="zero-config" class="table dt-table-hover dataTable no-footer" style="width: 100%;"
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="text-center dt-no-sorting" tabindex="0" style="min-width: 140px;"> Job
                                        Title</th>
                                ...
                                @foreach ($teams as $team)
                                    <tr role="row">
                                        ...
                                        <td class="text-center">
                                            <img src="{{ asset('storage/' . $team->image) }}" width="80" height="60">
                                        </td>
                                        ...
                                        <td class="text-center">{{ $team->created_at->format('Y-m-d H:i a') }}</td>
                                        <td class="text-center">{{ $team->updated_at->format('Y-m-d H:i a') }}</td>
                                        <td class="text-center">
                                            <ul class="table-controls action-btns">
                                                ...
                                                <li>
                                                    <button type="button" title="delete"
                                                        ...
                                                        data-bs-target="#deleteFish{{ $team->id }}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    <div class="modal modal-lg fade fadeInDown"
                                                        id="deleteFish{{ $team->id }}" tabindex="-1" role="dialog"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p class="modal-text">
                                                                        ...
                                                                        <br>
                                                                        <strong>Note: </strong> Team  will be deleted
                                                                        forever.
                                                                    </p>
                                                                </div>
...
@section('js')
    <script>
        ...
        $('.tableTitle').html("<span style='padding:6px;font-size:18px;'> Teams  (<span id='fishesCount'>" + c3.rows({
            search: 'applied'
        }).count() + "</span>) </span>");
        $('.table_btns').html(
            '<a href="{{ route('teams.create') }}" class="btn btn-primary" tabindex="0"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg></span></a>'
        );
    </script>
@endsection
