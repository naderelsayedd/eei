                        ...
                        <form action="{{ route('crop.update', ['crop' => $crop->id]) }}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="col-12 ">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" name="name[{{ $key }}]"
                                                            ...
                                                            value="{{ old('name', $crop->getTranslations()['name'][$key]) }}" placeholder="Crop name">
                                                        @error('name')
                                                    ...
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <textarea id="Pagedesc{{ $key }}" name="description[{{ $key }}]" class="form-control" placeholder="Crop mini description">{{ old('description', $crop->getTranslations()['description'][$key]) }}</textarea>
                                                        @error('description')
                                                            <div class="invalid-feedback">
                                                                <strong>{{ $message }}</strong>
                                                            </div>
                                                    ...
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <textarea id="cropPageContent{{ $key }}" name="content[{{ $key }}]" class="form-control"
                                                            placeholder="page content">{{ old('content', $crop->getTranslations()['content'][$key]) }}</textarea>
                                                        @error('content')
                                                            <div class="invalid-feedback">
                                                                <strong>{{ $message }}</strong>
                                                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select name="status" class="form-control">
                                    <option value="1" @if(old('status', $crop->status) == 1) selected @endif>Active</option>
                                    <option value="0" @if(old('status', $crop->status) == 0) selected @endif>Not Active</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">
                                        <strong>{{ $message }}</strong>
