                        ...
                        <table id="zero-config" class="table dt-table-hover dataTable no-footer" style="width: 100%;"
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="text-center sorting" tabindex="0" style="min-width: 80px;">Type</th>
                                    <th class="text-center dt-no-sorting" tabindex="0" style="min-width: 140px;">
                                        Description</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($products as $product)
                                    <tr role="row">
                                        ...
                                        <td class="text-center">
                                            <p
                                                style="max-height:104px; white-space: pre-wrap; overflow:hidden; margin-top: -34px">
                                                {{ $product->description }}
                                            </p>
                                        </td>
                                        <td class="text-center">
                                            <span
                                                class="badge @if ($product->status == 1) badge-light-success @else badge-light-danger @endif">{{ $product->statusName }}</span>
                                        </td>
                                        <td class="text-center">
                                            {{ $product->created_at ? $product->created_at->format('Y-m-d H:i a') : '' }}
                                        </td>
                                        <td class="text-center">
                                            {{ $product->updated_at ? $product->updated_at->format('Y-m-d H:i a') : '' }}</td>
                                        <td class="text-center">
                                            <ul class="table-controls action-btns">
                                                ...
                                                <li>
                                                    <button type="button" title="delete"
                                                        ...
                                                        data-bs-target="#deletePartener{{ $product->id }}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    <div class="modal modal-lg fade fadeInDown"
                                                        id="deletePartener{{ $product->id }}" tabindex="-1"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p class="modal-text">
                                                                        ...
                                                                        <br>
                                                                        <strong>Note: </strong> Product will be deleted
                                                                        forever.
                                                                    </p>
                                                                </div>
...
@section('js')
    <script>
        ...
        c3.on('draw', function() {
            $('#productsCount').text(c3.rows({
                search: 'applied'
            }).count());
        });


        $('.tableTitle').html("<span style='padding:6px;font-size:18px;'> Products (<span id='productsCount'>" + c3.rows({
            search: 'applied'
        }).count() + "</span>) </span>");
        $('.table_btns').html(
            '<a href="{{ route('products.create') }}" class="btn btn-primary" tabindex="0"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg></span></a>' +
