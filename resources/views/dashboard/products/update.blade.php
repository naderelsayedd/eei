                            ...
                            <form action="{{ route('products.update', ['product' => $product->id]) }}" method="post"
                                                    ...
                                                    <div class="col-12 ">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <input type="text" name="name[{{ $key }}]"
                                                                ...
                                                                value="{{ old('name', $product->getTranslations()['name'][$key]) }}"
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <textarea  id="Pagedesc{{ $key }}" name="description[{{ $key }}]" class="form-control" placeholder="Crop mini description">{{ old('description', $product->getTranslations()['description'][$key]) }}</textarea>
                                                            @error('description')
                                                                <div class="invalid-feedback">
                                                                    <strong>{{ $message }}</strong>
                                                                </div>
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <textarea id="cropPageContent{{ $key }}" name="content[{{ $key }}]" class="form-control"
                                                                placeholder="page content">{{ old('content', $product->getTranslations()['content'][$key]) }}</textarea>
                                                            @error('content')
                                                                <div class="invalid-feedback">
                                                                    <strong>{{ $message }}</strong>
                                                                </div>
                                    ...
                                    <select name="type" class="form-control">
                                        @foreach ($types as $type)
                                            <option value="{{ $type->id }}"
                                                @if (old('type', $product->product_type_id) == $type->id) selected @endif>
                                                {{ $type->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <select name="status" class="form-control">
                                        ...
                                        <option value="0" @if (old('status', $product->status) == 0) selected @endif>Not Active
                                        </option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">
