...
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #1e73be; background-image: url('website/assets/images/Header-bg.png'); background-repeat: no-repeat; background-size: cover; border-radius: 0; color: #000000; width: 700px;" width="700">
<tbody>
<tr>
...
<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
	<div align="center" class="alignment" style="line-height:10px">
		<a href="{{ route('home') }}" style="outline:none" tabindex="-1" target="_blank">
			<img alt="logo" src="{{ asset('storage/'.config('settings.logo')) }}" style="display: block; height: auto; border: 0; width: 180px; max-width: 100%;" title="logo" width="180"/>
		</a>
	</div>
</td>
</tr>
...
<h1 style="margin: 0; color: #555555; direction: ltr; font-family: Inter, sans-serif; font-size: 23px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder"></span></h1>
</td>
</tr>
</table>
</td>
...
<h2 style="margin: 0; color: #201f42; direction: ltr; font-family: 'Noto Serif', Georgia, serif; font-size: 24px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Your Admin Account Is Set</span></h2>
</td>
</tr>
</table>
<table border="0" cellpadding="10" cellspacing="0" class="paragraph_block block-3" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
	<tr>
	<td class="pad">
	<div style="color:#000000;direction:ltr;font-family:Inter, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:16.8px;">
...
<p style="margin: 0; margin-bottom: 0px;">Your admin accout to pst is set you access pst dashboard now.</p>
<p style="margin: 0;">Password: {{ $password }}</p>
<br>
<a href="{{ route('login') }}" target="_blank" style="margin-bottom:8px">Login</a>
</div>
</td>
</tr>
</table>
...
<td class="pad">
<div style="color:#000000;direction:ltr;font-family:Inter, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:16.8px;">
<p style="margin: 0; margin-bottom: 16px;">{{ config('settings.name_en') }}</p>
</div>
</td>
</tr>
</table>
...
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-radius: 0; color: #000000; background-size: auto; background-color: #333; width: 700px;" width="700">
<tbody>
<tr>
<td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 20px; padding-left: 30px; padding-right: 10px; padding-top: 20px; vertical-align: middle; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="33.333333333333336%">
<table border="0" cellpadding="0" cellspacing="0" class="image_block block-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
...
<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
	<div align="center" class="alignment" style="line-height:10px">
		<a href="{{ route('home') }}" style="outline:none" tabindex="-1" target="_blank">
			<img alt="logo" src="{{ asset('storage/'.config('settings.logo')) }}" style="display: block; height: auto; border: 0; width: 100px; max-width: 100%;" title="logo" width="100"/>
		</a>
	</div>
</td>
</tr>
...
<tr>
<td class="pad">
<div style="color:#ffffff;direction:ltr;font-family:Inter, sans-serif;font-size:13px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:right;mso-line-height-alt:16.8px;">
<p style="margin: 0;">Copyright © {{ date('Y').' '.config('settings.name_en') }}, All rights reserved.</p>
</div>
</td>
</tr>
</table>
